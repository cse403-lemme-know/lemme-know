...
<div class="controls">
	<div class="button" on:click={add(-1)} on:keypress={add(-1)}>
		<Arrow dir="left" />
	</div>
	<span class="button label" on:click={updateActiveView} on:keypress={updateActiveView}>
		{label}
	</span>
	<div class="button" on:click={add(1)} on:keydown={add(1)}>
		<Arrow dir="right" />
	</div>
</div>
